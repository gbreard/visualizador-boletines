...
def main_preprocessing():
    ...
    for sheet_name in sheets_to_process:
        ...
        if sheet_name == "Descriptores de actividad" or "Descriptores" in sheet_name:
            ...
            if not df_descriptores.empty:
                ...
                print("  ⚠️ No se pudieron extraer descriptores de la hoja.")
            continue
    ...
    # Asegurarse de que existe un archivo de descriptores (incluso vacío)
    output_descriptores = os.path.join(output_dir, "descriptores_actividad.csv")
    if not os.path.exists(output_descriptores):
        print("\nCreando archivo de descriptores vacío (para compatibilidad)...")
        pd.DataFrame(columns=["Codigo", "Descripcion"]).to_csv(output_descriptores, index=False)
        print(f"  ✓ Creado: {output_descriptores} (vacío)")
